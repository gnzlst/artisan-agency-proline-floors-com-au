...
@section('content')
    ...
    @endphp
    <div class="proline-section-padding">
        <div class="container mx-auto">
            <div class="flex flex-col md:flex-row gap-8">
                ...
                <div class="md:w-1/2">
                    ...
                    @endif
                    <h1 class="proline-section-large-text font-bold mb-4 proline-persimmon-text mt-5">{{ the_title() }}
                    </h1>
                    <div class="prose mt-2 proline-persimmon-text">{!! wpautop($overview) !!}</div>
                    <div class="proline-dark-text mt-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            @if ($cleaning)
                                <details class="py-4 group">
                                    <summary class="text-xl cursor-pointer select-none flex items-center justify-between">
                                        Cleaning
                                        <span class="ml-2 transition-transform group-open:rotate-90">
                                            <svg class="w-4 h-4 text-proline-dark group-hover:text-proline-persimmon"
                            ...
                            <details class="py-4 group">
                                ...
                                <div class="prose mt-2"><a href="/where-to-buy/">Find you nearest Proline provider</a></div>
                            </details>
                            <details class="py-4 group">
                                <summary class="text-xl cursor-pointer select-none flex items-center justify-between">
                                    <a href="/contact-us/">Request a Retailer Measure and Quote</a>
                                </summary>
                            </details>
                        </div>
                    </div>
                    <div class="mt-8">
                        <form class="flex flex-col items-start w-full" method="post"
                        ...
                        @foreach ($related_products as $related)
                            <div class="block overflow-hidden h-full flex flex-col">
                                ...
                                <div class="py-4 flex-1 flex flex-col justify-between">
                                    ...
                                    @endif
                                    <h2 class="text-xl mb-2">{{ get_the_title($related->ID) }}</h2>
